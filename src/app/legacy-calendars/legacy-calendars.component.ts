...
@Component({
  selector: 'app-legacy-calendars',
  templateUrl: './legacy-calendars.component.html',
  styleUrls: ['./legacy-calendars.component.scss']
})
export class LegacyCalendarsComponent implements OnInit {
